<#
.SYNOPSIS
    PowerShell WPF GUI for Windows 11 24H2 with Default Apps and Apps & Features buttons.

.DESCRIPTION
    Provides a simple WPF GUI to open Default Apps and Apps & Features settings.
...
$window.Title = "Windows 11 Apps Settings"
...
$header.Text = "Apps & Features Settings"
$header.FontSize = 16
